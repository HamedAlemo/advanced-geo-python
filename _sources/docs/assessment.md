...
1. **Participation**: This will be an active, hands-on course in which we learn and develop new packages and methods during the semester. Student contributions to problem solving and to class discussions represent **5% of the final grade**.  
2. **Quizzes**: There will be a total of 7 short quizzes in the class. Each quiz will be limited to a few questions from the previous lecture. This will be **10% of the final grade**. 
3. **Assignments**: There will be a total of 9 assignments. Most assignments will have a *Agentic AI Reflection* section in which students should describe the specification they gave to the agent, how they decomposed it, how they verified each output, and where they rejected or corrected the agent. This will be **35% of the final grade**. 
4. **Final project**: The final project will be undertaken in teams of up to 2 students, and will consist of two parts:
    
    * A _project proposal_, providing a summary of the proposed work, the datasets and methodology that will be used, the delineation of specific tasks undertaken by each team member, and then expected results. Each team needs to also present their proposal in the class. This component will account for **10% of the final grade**.
    
    * The _final project repository and report_. The repository will contain all the code and analytical steps used to perform the analysis (including documentation of the content and steps to reproduce the results), with the report submitted as a Jupyter notebook providing a summary of the project rationale, analyses undertaken, key results (illustrated with key figures, graphs, and tables), and discussion, including unexpected results, challenges encountered, and suggested improvements. This component will be worth **40% (300-level) of the final grade**. 
